        ...
        <div class="layui-tab-content">
                ...
                <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" style="line-height:36px;">
                            stream_socket_client函数<i class="layui-icon layui-icon-ok-circle" style="color: <?php  echo function_exists('stream_socket_client')?'#5FB878':'#f2f2f2';?>"></i>&nbsp;&nbsp;&nbsp; fsockopen函数 <i class="layui-icon layui-icon-ok-circle"
                                style="color: <?php  echo function_exists('fsockopen')?'#5FB878':'#f2f2f2';?>"></i>
            ...
            <div class="layui-tab-item">
                <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">API上传状态</label>
                        <div class="layui-input-block">
                            <input type="radio" name="api_up" value="1" <?php if ($this->vars['configs']['api_up']['value']==1) {?> checked="checked" <?php } ?> title="启用">
                            <input type="radio" name="api_up" value="0" <?php if ($this->vars['configs']['api_up']['value']==0) {?> checked="checked" <?php } ?> title="禁用">
                        </div>
                    </div>
            ...
            <div class="layui-tab-item">
                <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <a class="layui-btn layui-btn-warm" onclick="GetPictureFolder(1,'watermark_pic');">图库</a>
                        <div id="watermark_pic_box" class="pic">
                            <dl><dt><?php if (@$this->vars['configs']['watermark_pic']['value']) {?><img src="<?php echo SITE_DIR;?><?php echo @$this->vars['configs']['watermark_pic']['value'];?>" data-url="<?php echo @$this->vars['configs']['watermark_pic']['value'];?>"></dt>
                                <dd>删除</dd>
                            </dl><?php } ?></div>
                    </div>
            ...
            <div class="layui-tab-item">
                <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">搜索验证码</label>
                        <div class="layui-input-block">
                            <input type="radio" name="search_check_code" value="1" <?php if ($this->vars['configs']['search_check_code']['value']=='1' ||$this->vars['configs']['search_check_code']['value']=='' ) {?> checked="checked" <?php } ?> title="启用">
                            <input type="radio" name="search_check_code" value="0" <?php if ($this->vars['configs']['search_check_code']['value']=='0' ) {?> checked="checked" <?php } ?> title="禁用">
                        </div>
                    </div>
            ...
            <div class="layui-tab-item">
                <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">七牛状态</label>
                        <div class="layui-input-block">
                            <input type="radio" name="qiniu_open" value="1" <?php if ($this->vars['configs']['qiniu_open']['value']==1) {?> checked="checked" <?php } ?> title="启用">
                            <input type="radio" name="qiniu_open" value="0" <?php if ($this->vars['configs']['qiniu_open']['value']==0) {?> checked="checked" <?php } ?> title="禁用">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="qiniu_access_key" value="<?php echo @$this->vars['configs']['qiniu_access_key']['value'];?>" placeholder="请输入access_key" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="qiniu_secret_key" value="<?php echo @$this->vars['configs']['qiniu_secret_key']['value'];?>" placeholder="请输入secret_key" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="qiniu_bucket" value="<?php echo @$this->vars['configs']['qiniu_bucket']['value'];?>" placeholder="请输入bucket" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="qiniu_url" value="<?php echo @$this->vars['configs']['qiniu_url']['value'];?>" placeholder="请输入七牛URL" class="layui-input">
                        </div>
                    </div>
