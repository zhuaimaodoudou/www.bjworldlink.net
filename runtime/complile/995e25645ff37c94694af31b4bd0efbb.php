	  		...
	  		<form action="<?php echo \core\basic\Url::get('/admin/Company/mod');?>" method="post">
	  			...
	  			<div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                         <input type="text" name="enname" value="<?php echo @$this->getVar('companys')->enname;?>" placeholder="请输入公司名称"  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     ...
                     <a class="layui-btn layui-btn-warm" onclick="GetPictureFolder(1,'weixin');">图库</a>
