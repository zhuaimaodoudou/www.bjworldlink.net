	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                    		...
	                    		<?php if ($value->type==10) {?>轮播多图<?php } ?>
	                    		<?php if ($value->type==11) {?>单选关联<?php } ?>
	                    		<?php if ($value->type==12) {?>多选关联<?php } ?>
	                    		<?php if ($value->type==13) {?>属性名&值<?php } ?>
						</td>
	   			...
	   			<form action="<?php echo \core\basic\Url::get('/admin/ExtField/add');?>" method="post" class="layui-form">
	   				...
	   				<div class="layui-form-item">
	                     ...
	                     <div class="layui-input-block">
		                    ...
		                    <input type="checkbox" value="<?php echo $value->mcode; ?>" title="<?php echo $value->name; ?>" name="mcode[]">
		                    <?php } ?>
	                     </div>
	                </div>
	  		...
	  		<form action="<?php echo \core\basic\Url::get('/admin/ExtField/mod/id/'.get('id').'');?><?php echo $this->getVar('backurl');?>" method="post" class="layui-form">
	  			...
	  			<div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
	                    <?php $num = 0;foreach ($this->getVar('models') as $key => $value) { $num++;?>	
	                    <?php  
      					$checkboxs=explode(',',$this->getVar('extfield')->mcode);
      					$value2 = $value->mcode;
      					$name2 = $value->name;
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	 <select name="type" lay-verify="required">
	                    	...
	                    	<?php if ($this->getVar('extfield')->type!=2 && $this->getVar('extfield')->type!=7 && $this->getVar('extfield')->type!=8 && $this->getVar('extfield')->type!=10 && $this->getVar('extfield')->type!=11 && $this->getVar('extfield')->type!=12) {?>
	                    		...
	                    		<option value="13" <?php if ($this->getVar('extfield')->type==13) {?>selected<?php } ?>>属性名&值</option>
	                    	<?php } ?>
	                    	<?php if ($this->getVar('extfield')->type==11 || $this->getVar('extfield')->type==12) {?>
	                    		<option value="11" <?php if ($this->getVar('extfield')->type==11) {?>selected<?php } ?>>单选关联</option>
	                    		<option value="12" <?php if ($this->getVar('extfield')->type==12) {?>selected<?php } ?>>多选关联</option>
	                    	<?php } ?>
	                    </select>
                     </div>
                </div>
